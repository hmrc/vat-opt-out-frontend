...
class MainTemplateSpec extends ViewBaseSpec {
  ...
  "The Main Template" when {
    ...
    "the user is an individual or organisation" should {
      ...
      lazy val view = injectedView(pageTitle = "", user = Some(clientUser))(Html("Test"))(messages, appConfig, request)
    ...
    "the user is an agent" should {
      ...
      lazy val view = injectedView(pageTitle = "", user = Some(agentUser))(Html("Test"))(messages, appConfig, request)
      lazy implicit val document: Document = Jsoup.parse(view.body)
    ...
    "the user is not known" should {
      ...
      lazy val view = injectedView(pageTitle = "", user = None)(Html("Test"))(messages, appConfig, request)
      lazy implicit val document: Document = Jsoup.parse(view.body)
